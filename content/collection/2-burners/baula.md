---
title: "Baula"
date: 2023-09-20T10:49:09Z

---
![Baula](/images/baula.png)
{{% notice style="secondary" icon="fas fa-file-pdf" %}}
[Download Spec File](/pdfs/PITT-cooking-Techn.-Document-Baula-NL-EN.pdf)
{{% /notice %}}

Model with 2 gas hobs. Named after a volcano in Iceland.

{{< product_details 
  type_of_burners="1x 1.1 - 10.8 MJ, 1x 0.7 - 18 MJ"
  editions="Professional (brass), Black (full black), Original (aluminium *commercial only)"
  controls="Top Side"
  module_dimensions="533 x 403 x 89 mm"
